...
//static EditViewController *editViewController = nil;
@implementation EditViewController

@synthesize titleView = titleView ;

//把EditViewController设计成单例
//防止alloc 或 new 产生新的对象
//+(id)allocWithZone:(struct _NSZone *)zone
//{
//    if (editViewController ==nil)
//    {
//        editViewController = [[super allocWithZone:zone]init];
//    }
...
- (void)viewDidLoad {
    ...
    /*-----------DrawView---------------------*/
    DrawView *drawView = [[DrawView alloc]initWithFrame:CGRectMake(0, 0, scrollView.frame.size.width, scrollView.frame.size.height)];
    drawView.tag = 1000+count ;
//    drawView.backgroundImage = [UIImage imageNamed:@"save_new2"];
    ...
    /*--------------titleView----------------------*/
    titleView = [[UIScrollView alloc]initWithFrame:CGRectMake(Screen_Width/2-100, 64, 200, 40*count)];
    titleView.backgroundColor = [UIColor colorWithRed:248/255.0 green:248/255.0 blue:248/255.0 alpha:1];
    titleView.layer.cornerRadius = 5;
    titleView.layer.masksToBounds = YES ;
    titleView.tag = 300;
    titleView.hidden = YES ;
    titleView.contentSize = CGSizeMake(0, 35);
    [self.view addSubview:titleView];
    
    /*--------------titleButton---------------------------*/
    UIButton *titleButton = [UIButton buttonWithType:UIButtonTypeSystem];
    titleButton.frame = CGRectMake(25, 5, 150, 30);
    [titleButton setTitle:@"图片1" forState:UIControlStateNormal];
...
//    NSLog(@"viewDidLoad = %lu",scrollView.subviews.count);
}
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    if (buttonIndex == 0)
    {
        ...
        //删除后修改titleView的高度
        titleView.frame = CGRectMake(Screen_Width/2-100, 64, 200, 35*(count));
        if (35*(count - 1) <= Screen_Height - 64 - 44 )
        {
            NSLog(@"aa");
            titleView.contentSize = CGSizeMake(0, 35*count);
        }
...
-(void)addAction:(UIButton *)sender
{
    ...
    if (35*(count-1) >= Screen_Height - 64 - 44 )
    {
        titleView.contentSize = CGSizeMake(0, 35*count+40);
    }
    titleView.showsVerticalScrollIndicator = NO ;
    ...
    //currentPage
    currentPage = count;
//    NSLog(@"addAction = %lu",scrollView.subviews.count);
}
...
//    NSLog(@"titleAciton = %lu",scrollView.subviews.count);
}
...
-(void)changePageAction:(UIButton *)sender
{
    ...
    currentPage = page ;
    [scrollView setContentOffset:CGPointMake(scrollView.frame.size.width*(page-1), 0) animated:YES];
}
